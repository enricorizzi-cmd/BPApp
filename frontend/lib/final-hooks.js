...
(function(){
  ...
  function highlightToday(root){
    // Usa UTC per coerenza con backend, fallback a locale
    var today = (window.BPTimezone && window.BPTimezone.ymdUTC) ? window.BPTimezone.ymdUTC(new Date()) : ymdLocal(new Date());
